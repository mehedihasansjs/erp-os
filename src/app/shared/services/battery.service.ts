 ...
 * you be notified by events that are sent when the battery level or charging status change.
 * This can be used to adjust your app's resource usage to reduce battery drain when the battery is low,
 * or to save changes before the battery runs out in order to prevent data loss.
 * 
